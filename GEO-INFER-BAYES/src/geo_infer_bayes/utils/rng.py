"""Explicit random-number-generator plumbing for GEO-INFER-BAYES.

MCMC, HMC, SMC/ABC, variational inference and posterior predictive sampling all
draw randomness, and a posterior is only auditable if the chain behind it can
