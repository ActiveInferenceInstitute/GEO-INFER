# Agent Instructions: GEO-INFER-COG

## Scope

- Owning module: `GEO-INFER-COG`
- Python package: `geo_infer_cog`
- Directory role: Human-centered geospatial tools that model perception, reasoning, and spatial cognition for intuitive interfaces.
