# GEO-INFER-COG/src/geo_infer_cog/spatial_language

Spatial Language workspace within `GEO-INFER-COG`.
...
- `processor.py:SpatialEntity` (class)
- `processor.py:SpatialRelation` (class)
- `processor.py:SpatialLanguageProcessor` (class)
