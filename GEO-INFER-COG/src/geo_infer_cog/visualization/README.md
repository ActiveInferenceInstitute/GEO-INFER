# GEO-INFER-COG/src/geo_infer_cog/visualization

Visualization workspace within `GEO-INFER-COG`.
...
- `adapters.py:VisualizationElement` (class)
- `adapters.py:ColorScheme` (class)
- `adapters.py:HumanCenteredVisualizer` (class)
