# Agent Instructions: GEO-INFER-PLACE/src/geo_infer_place/hydrography/data/smith_expanded

## Scope

- Owning module: `GEO-INFER-PLACE`
- Python package: `geo_infer_place`
- Directory role: Smith Expanded workspace within `GEO-INFER-PLACE`.
