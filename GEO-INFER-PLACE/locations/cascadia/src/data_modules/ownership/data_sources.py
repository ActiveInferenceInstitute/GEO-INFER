...
class CascadianOwnershipDataSources:
    ...
    def __init__(self):
        ...
        self.arcgis_service_urls = {
            ...
            'DEL_NORTE': self.config.get('data_sources', {}).get('del_norte_parcels', {}).get('url')
        }
    ...
    def _query_osm_overpass(self, bbox: tuple) -> gpd.GeoDataFrame:
        ...
        logger.info("Ownership: Querying OpenStreetMap Overpass API for buildings (parcel proxy)...")
                        ...
                        try:
                            ...
                            if poly.is_valid:
                                ...
                                feature = {
                                    ...
                                    'OWNER_NAME': tags.get('operator') or tags.get('name') or 'Unknown',
                                    'LAND_USE': tags.get('building'),
                                    'ACRES': poly.area * 111000 * 111000 * 0.000247105, # Very rough estimate, mainly for relative size
                                    'is_synthetic': False
                                }
