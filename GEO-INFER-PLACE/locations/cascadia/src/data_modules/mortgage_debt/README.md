# GEO-INFER-PLACE/locations/cascadia/src/data_modules/mortgage_debt

Mortgage Debt workspace within `GEO-INFER-PLACE`.
...
- `data_sources.py:CascadianMortgageDataSources` (class)
- `geo_infer_mortgage_debt.py:GeoInferMortgageDebt` (class)
