# GEO-INFER-PLACE/locations/cascadia/src/data_modules/water_rights

Water Rights workspace within `GEO-INFER-PLACE`.
...
- `data_sources.py:CascadianWaterRightsDataSources` (class)
- `geo_infer_water_rights.py:GeoInferWaterRights` (class)
