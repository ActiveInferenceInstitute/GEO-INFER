...
Behavior:
- Checks for cached real datasets in del_norte_dashboard/ folder (fire perimeters, tide levels)
- If not present or if --refresh is passed, fetches fresh data
- Generates the dashboard HTML in del_norte_dashboard/ folder
...
def main() -> None:
    ...
    out_dir = Path(__file__).parent / "del_norte_dashboard"
