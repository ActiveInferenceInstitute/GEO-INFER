# Agent Instructions: GEO-INFER-EDU

## Scope

- Owning module: `GEO-INFER-EDU`
- Python package: `geo_infer_edu`
- Directory role: Educational technology for geospatial systems including curriculum design, interactive exercises, and learning analytics.
