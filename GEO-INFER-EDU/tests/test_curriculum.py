...
class TestCurriculumDesigner:
    ...
    def test_module_content(self, designer):
        ...
        curriculum = designer.design(
            topic="cartography", level="professional", duration="4_weeks"
        )
    ...
    def test_align_with_standards(self, designer):
        ...
        curriculum = designer.design(
            topic="gis_programming", level="undergraduate", duration="8_weeks"
        )
    ...
    def test_create_learning_pathway(self, designer):
        ...
        learner_profile = {"id": "learner_001", "current_skills": ["data_management"]}
    ...
    def test_export_curriculum_yaml(self, designer):
        ...
        curriculum = designer.design(
            topic="remote_sensing", level="intermediate", duration="4_weeks"
        )
    ...
    def test_export_curriculum_json(self, designer):
        ...
        curriculum = designer.design(
            topic="web_mapping", level="professional", duration="4_weeks"
        )
    ...
    def test_export_invalid_format(self, designer):
        ...
        curriculum = designer.design(
            topic="test", level="undergraduate", duration="4_weeks"
        )
    ...
    def test_education_levels(self, designer):
        ...
        for level in levels:
            curriculum = designer.design(
                topic="gis_basics", level=level, duration="2_weeks"
            )
...
class TestStandardsValidation:
    ...
    def test_gistbok_produces_alignment(self):
        ...
        assert (
            "UCGIS GIS&T Body of Knowledge (GISTBOK)" in curriculum.standards_alignment
        )
        assert curriculum.standards_alignment["UCGIS GIS&T Body of Knowledge (GISTBOK)"]
