...
def sample_soil_data():
    ...
    geometries = [Point(5, 5), Point(22.5, 2.5), Point(35, 15)]
...
def sample_time_series_data():
    ...
    # Create date range
    dates = pd.date_range(
        start=datetime.now() - timedelta(days=120), end=datetime.now(), freq="D"
    )
