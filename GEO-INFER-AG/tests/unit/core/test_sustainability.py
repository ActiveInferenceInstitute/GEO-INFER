...
class TestSustainabilityAssessment:
    ...
    def test_assess_carbon_sequestration(self, sample_field_data):
        ...
        metrics = sa.assess_carbon_sequestration(field_data=sample_field_data)
        ...
        metrics = sa.assess_carbon_sequestration(
            field_data=sample_field_data, management_practices=management_practices
        )
        ...
        field1_modifier = (
            metrics["field_data"]
            .loc[metrics["field_data"]["field_id"] == "field_1", "management_modifier"]
            .iloc[0]
        )

        field3_modifier = (
            metrics["field_data"]
            .loc[metrics["field_data"]["field_id"] == "field_3", "management_modifier"]
            .iloc[0]
        )
    ...
    def test_assess_water_usage(self, sample_field_data):
        ...
        # Test with explicit field data
        metrics = sa.assess_water_usage(field_data=sample_field_data)
    ...
    def test_assess_soil_health(self, sample_field_data, sample_soil_data):
        ...
        metrics = sa.assess_soil_health(
            field_data=sample_field_data, soil_data=sample_soil_data
        )
    ...
    def test_assess_biodiversity(self, sample_field_data):
        ...
        # Test with explicit field data
        metrics = sa.assess_biodiversity(field_data=sample_field_data)
        ...
        field1_modifier = (
            metrics["field_data"]
            .loc[
                metrics["field_data"]["field_id"] == "field_1", "biodiversity_modifier"
            ]
            .iloc[0]
        )
        ...
        field3_modifier = (
            metrics["field_data"]
            .loc[
                metrics["field_data"]["field_id"] == "field_3", "biodiversity_modifier"
            ]
            .iloc[0]
        )
        ...
        metrics = sa.assess_biodiversity(
            field_data=sample_field_data, protected_areas=protected_areas
        )
    ...
    def test_plot_sustainability_metrics(self, sample_field_data, sample_soil_data):
        ...
        fig, ax = plt.subplots()
        result_ax = sa.plot_sustainability_metrics(
            ax=ax, metric_type="sustainability_index"
        )
