...
class TestAgriculturalAnalysis:
    ...
    def test_prepare_data(
        self, sample_field_data, sample_weather_data, sample_soil_data
    ):
        ...
        prepared_data = analyzer._prepare_data(
            sample_field_data, sample_weather_data, sample_soil_data
        )
    ...
    def test_run_analysis(self, sample_field_data, sample_weather_data, mocker):
        ...
        mock_model.predict.return_value = {
            ...
            "spatial_results": {"predicted_yield": [5.0, 6.0, 7.0]},
            "metadata": {"name": "test_model", "crop_type": "corn"},
        }
        ...
        results = analyzer.run(
            field_data=sample_field_data, weather_data=sample_weather_data
        )
...
class TestAgriculturalResults:
    ...
    def test_merge_results(self, sample_field_data):
        ...
        model_results = {"predictions": [5.0, 6.0, 7.0]}
        model_metadata = {"name": "test_model"}
