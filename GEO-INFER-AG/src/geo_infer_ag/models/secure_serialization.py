"""
Authenticated serialization envelopes for GEO-INFER-AG.

This module is the trust boundary for every persisted model payload in
GEO-INFER-AG: ``AgricultureModel.save``/``load`` in
:mod:`geo_infer_ag.models.base` and the joblib-backed subclasses
(crop yield, soil health, carbon sequestration, water usage).
...
CONTEXT_MODEL_SAVE = "ag.model.save"
