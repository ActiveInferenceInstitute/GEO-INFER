...
This project is indexed by GitNexus as **GEO-INFER** (64684 symbols, 91155 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
