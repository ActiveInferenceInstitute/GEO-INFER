...
This project is indexed by GitNexus as **GEO-INFER** (67245 symbols, 96848 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
