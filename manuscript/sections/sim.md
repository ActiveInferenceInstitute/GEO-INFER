...
The test census counts 9 test files with 19 test classes and 72 test functions, covering engine stepping, each paradigm's dynamics, and scenario management.
