...
The test census counts 10 test files in `tests/` with 36 test classes and 106 test functions, covering the exported engines against synthetic marine fixtures. The package source totals approximately 1,734 lines of Python, keeping the module small enough to audit end to end.
