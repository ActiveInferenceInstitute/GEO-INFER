...
**Verification status.** The `tests/` directory is present with 10 test files, one layer covering each major component family; testing routes through the unified runner (`--module CLIMATE`).
