...
The test census counts 15 test files with 7 test classes and 168 test functions. The many functions against few classes indicate flat, scenario-driven tests — orchestration flows, deployment steps, and health-check outcomes exercised directly rather than through deep object hierarchies.
