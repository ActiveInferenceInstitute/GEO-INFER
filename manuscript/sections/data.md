...
**Verification status.** The `tests/` directory is present with 23 test files, covering ingestion, pipeline, storage, and quality layers; testing routes through the unified runner (`--module DATA`).
