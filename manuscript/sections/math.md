...
The test census counts 19 test files with 97 test classes and 318 test functions — the deepest statistical test coverage in the monorepo — exercising estimators, interpolators, and geometric primitives against reference values.
