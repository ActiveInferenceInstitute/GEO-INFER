"""
Authenticated serialization envelopes for GEO-INFER-LOG.

This module is the trust boundary for every persisted payload in
GEO-INFER-LOG: the gpickle transportation-network files loaded by
``_load_gpickle`` in :mod:`geo_infer_log.core.routing`.
...
CONTEXT_NETWORK = "log.routing.network"
