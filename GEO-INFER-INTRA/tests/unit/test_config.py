...
class TestConfig:
    ...
    def test_load_yaml_config(self, tmp_path):
        ...
        test_config = {
            "general": {"debug_mode": True, "log_level": "DEBUG"},
            "documentation": {"server": {"host": "localhost", "port": 8000}},
        }
    ...
    def test_merge_configs(self):
        ...
        base_config = {
            "general": {"debug_mode": False, "log_level": "INFO"},
            "documentation": {"server": {"host": "localhost", "port": 8000}},
        }
        ...
        assert (
            merged_config["documentation"]["server"]["host"] == "localhost"
        )  # Not overridden
