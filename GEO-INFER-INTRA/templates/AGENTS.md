# Agent Instructions: GEO-INFER-INTRA/templates

## Scope

- Owning module: `GEO-INFER-INTRA`
- Python package: `geo_infer_intra`
- Directory role: Templates workspace within `GEO-INFER-INTRA`.
...
- `MODULE_DEVELOPMENT_GUIDELINES.md`
- `MODULE_PROPOSAL_TEMPLATE.md`
