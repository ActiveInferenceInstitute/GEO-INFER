...
FEATURE -- fineScale --> DETAILED[Representation]
...
``` xml
<owl:Ontology rdf:about="/ontology/geospatial">
<!-- Classes -->
...
PREFIX geo: </ontology/geospatial#>
SELECT ?city
WHERE {
?city a geo:City .
?state a geo:State .
...
- [Reasoning Techniques](reasoning.md)
