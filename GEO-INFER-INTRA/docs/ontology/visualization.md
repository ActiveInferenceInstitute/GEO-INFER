...
This document provides a guide to visualizing ontologies in GEO-INFER-INTRA, covering visualization techniques, tools, and best practices.
## Contents
...
const visualizer = GeoInfer.OntologyVisualizer({
...
- [Knowledge Base Visualization](visualization.md)
- [Interactive User Interface])
- [Geospatial Data Visualization](visualization.md)
