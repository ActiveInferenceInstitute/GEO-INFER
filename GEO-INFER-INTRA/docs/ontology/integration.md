...
This document provides a guide to integrating ontologies in GEO-INFER-INTRA, covering methods, tools, and best practices.
## Contents
...
- **Knowledge Coverage**: Combining ontologies expands the knowledge domain
...
```
#### Merge Strategies
- **Merge**: integration of all concepts and relationships
...
print(f"Found {len(results)} results using ontology-search")
