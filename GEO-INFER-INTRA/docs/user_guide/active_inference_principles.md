...
This Bayesian update combines prior beliefs with observations.
...
Active inference guides spatial sampling by maximizing information gain:
```python
...
- [Implementation Details](../developer_guide/index.md)
- [Practical Examples](../examples_gallery.md)
- [Research Papers])
