...
Enabling structured progression from foundational to advanced geospatial concepts.
...
**Ready to get started?** Check out the **[Curriculum Design Tutorial](../getting_started/curriculum_design.md)** or explore **[Interactive Exercise Examples](../examples/interactive_exercises.md)**!
