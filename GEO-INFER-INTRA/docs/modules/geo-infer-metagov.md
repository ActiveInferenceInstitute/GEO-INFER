...
Pre-rendered spatial snapshot for **GEO-INFER-METAGOV** (*Meta-Governance & Organizational Governance Module*). Reproducible preview cards are generated by `geo_infer_intra.core.documentation.visual_preview`.
