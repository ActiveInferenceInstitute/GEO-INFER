...
Pre-rendered spatial snapshot for **GEO-INFER-ENERGY** (*Energy Systems Module*). Reproducible preview cards are generated by `geo_infer_intra.core.documentation.visual_preview`.
