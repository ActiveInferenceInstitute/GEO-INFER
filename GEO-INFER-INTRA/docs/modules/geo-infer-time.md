...
| Preview | Widget |
| --- | --- |
| ![GEO-INFER-TIME Leaflet Preview](previews/geo-infer-time_preview.svg) | Leaflet HTMLMap · SVG vector · PNG raster |

> **Reproducible contract:** each map ships as `geo-infer-time_preview.html`, `geo-infer-time_preview.svg`, `geo-infer-time_preview.png`, and `geo-infer-time_preview.manifest.json` beneath `previews/`. The receipt records an input SHA-256 and artifact accessibility checks.
