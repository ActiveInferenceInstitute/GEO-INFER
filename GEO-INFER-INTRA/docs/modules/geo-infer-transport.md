...
**Purpose**: Forecast travel demand and patterns.
...
**Purpose**: Model and analyze transportation networks.

```python
from geo_infer_transport import NetworkModeler
...
**Purpose**: Plan and evaluate transportation infrastructure.

```python
from geo_infer_transport import InfrastructurePlanner
...
**Problem**: Plan new transit routes and evaluate service changes.

```python
from geo_infer_transport import DemandForecaster, NetworkModeler, InfrastructurePlanner
...
```python
from geo_infer_transport import RouteOptimizer, TrafficAnalyzer
...
**Ready to get started?** Check out the **[Traffic Analysis Tutorial](../getting_started/traffic_analysis.md)** or explore **[Route Optimization Examples](../examples/route_optimization.md)**!
