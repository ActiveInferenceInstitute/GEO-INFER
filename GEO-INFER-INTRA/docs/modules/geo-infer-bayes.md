...
**Problem**: Assess environmental risks with uncertainty quantification.
...
### Tutorials
- **[Bayesian Inference Basics](../getting_started/index.md)** - Learn Bayesian inference fundamentals
- **[Hierarchical Modeling Tutorial](../getting_started/index.md)** - Build hierarchical Bayesian models
- **[Uncertainty Quantification Tutorial](../getting_started/index.md)** - Quantify uncertainty in predictions
### How-to Guides
- **[Environmental Risk Assessment with Bayesian Methods](../examples_gallery.md)** - Assess environmental risks using Bayesian methods
- **[Climate Change Analysis with Bayesian Inference](../examples_gallery.md)** - Analyze climate change with Bayesian uncertainty
- **[Economic Forecasting with Bayesian Time Series](../examples_gallery.md)** - Forecast economic indicators with Bayesian methods
### Technical Reference
- **[Bayesian API Reference](../api/reference.md)** - Bayesian API documentation
- **[MCMC Sampling Methods](../api/reference.md)** - Available MCMC sampling methods
- **[Uncertainty Quantification Methods](../api/reference.md)** - Available uncertainty quantification methods
### Explanations
- **Bayesian Theory** - Deep dive into Bayesian concepts
- **MCMC Sampling Theory** - Understanding MCMC sampling
- **Uncertainty Quantification Theory** - Uncertainty quantification foundations
### Related Modules
...
---
**Ready to get started?** Check out the **[Bayesian Inference Basics Tutorial](../getting_started/index.md)** or explore **[Environmental Risk Assessment Examples](../examples_gallery.md)**!

## 🗺️ Interactive Spatial Preview

Pre-rendered spatial snapshot for **GEO-INFER-BAYES** (*Bayesian Inference Engine*). Reproducible preview cards are generated by `geo_infer_intra.core.documentation.visual_preview`.

| Preview | Widget |
| --- | --- |
| ![GEO-INFER-BAYES Leaflet Preview](previews/geo-infer-bayes_preview.svg) | [Interactive map](previews/geo-infer-bayes_preview.html) · [PNG](previews/geo-infer-bayes_preview.png) |

> **Reproducible contract:** each map ships as `geo-infer-bayes_preview.html`, `geo-infer-bayes_preview.svg`, `geo-infer-bayes_preview.png`, and `geo-infer-bayes_preview.manifest.json` beneath `previews/`. The receipt records geometry provenance and artifact SHA-256 hashes. Values are illustrative, not observations.