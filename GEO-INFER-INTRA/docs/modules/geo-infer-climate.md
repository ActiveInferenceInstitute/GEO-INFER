...
### Tutorials
- **[Climate Analysis Basics](geo-infer-climate.md)** - Getting started with climate analysis
- **[Climate Projections](../getting_started/index.md)** - Working with future projections
### Technical Reference
- **[API Reference](../api/reference.md)** - API documentation
- **[Climate Indices](../advanced/index.md)** - Climate index calculations
### Related Modules
...
---
**Ready to get started?** Check out the **[Climate Analysis Basics Tutorial](geo-infer-climate.md)** or explore **[Agricultural Climate Risk Examples](../examples_gallery.md)**!

## 🗺️ Interactive Spatial Preview

Pre-rendered spatial snapshot for **GEO-INFER-CLIMATE** (*Climate Analysis Module*). Reproducible preview cards are generated by `geo_infer_intra.core.documentation.visual_preview`.

| Preview | Widget |
| --- | --- |
| ![GEO-INFER-CLIMATE Leaflet Preview](previews/geo-infer-climate_preview.svg) | [Interactive map](previews/geo-infer-climate_preview.html) · [PNG](previews/geo-infer-climate_preview.png) |

> **Reproducible contract:** each map ships as `geo-infer-climate_preview.html`, `geo-infer-climate_preview.svg`, `geo-infer-climate_preview.png`, and `geo-infer-climate_preview.manifest.json` beneath `previews/`. The receipt records geometry provenance and artifact SHA-256 hashes. Values are illustrative, not observations.