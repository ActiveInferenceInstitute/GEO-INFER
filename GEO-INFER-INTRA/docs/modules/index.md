...
description: "guide to all GEO-INFER modules, their capabilities, and integration patterns"
purpose: "Understanding the GEO-INFER framework and module ecosystem"
...
> **Purpose**: Understanding the GEO-INFER framework
>
> This overview provides a guide to all GEO-INFER modules, their capabilities, dependencies, and integration patterns that enable geospatial inference capabilities.
...
|--------|-------------|--------|--------------|
| **[GEO-INFER-ACT](../modules/geo-infer-act.md)** | Active Inference Engine | ✅ | MATH, BAYES, SPACE |
| **[GEO-INFER-BAYES](../modules/geo-infer-bayes.md)** | Bayesian Inference Engine | ✅ | MATH, SPACE |
| **[GEO-INFER-AI](../modules/geo-infer-ai.md)** | Artificial Intelligence Engine | ✅ | ACT, MATH, SPACE |
| **[GEO-INFER-MATH](../modules/geo-infer-math.md)** | Mathematical Foundations | ✅ | None |
| **[GEO-INFER-COG](../modules/geo-infer-cog.md)** | Cognitive Modeling | 🔄 In Development | ACT, AI |
| **[GEO-INFER-AGENT](../modules/geo-infer-agent.md)** | Multi-Agent Systems | ✅ | ACT, AI, SPACE |
| **[GEO-INFER-SPM](../modules/geo-infer-spm.md)** | Statistical Parametric Mapping | 🔄 In Development | SPACE, MATH |

### 🗺️ Spatial-Temporal

| Module | Description | Status | Dependencies |
|--------|-------------|--------|--------------|
| **[GEO-INFER-SPACE](../modules/geo-infer-space.md)** | Spatial Analysis Engine | ✅ | MATH, H3 |
| **[GEO-INFER-TIME](../modules/geo-infer-time.md)** | Temporal Analysis Engine | ✅ | MATH, AI |
...
| **[GEO-INFER-API](../modules/geo-infer-api.md)** | API Management System | ✅ | All modules |
...
| **[GEO-INFER-ANT](../modules/geo-infer-ant.md)** | Ant Colony Optimization | ✅ | MATH, SPACE |
...
| Module | Description | Status | Dependencies |
|--------|-------------|--------|--------------|
| **[GEO-INFER-AG](../modules/geo-infer-ag.md)** | Agricultural Systems | ✅ | SPACE, TIME, ACT |
...
| **[GEO-INFER-LOG](../modules/geo-infer-log.md)** | Logistics & Supply Chain | 🔄 In Development | None |
...
| **[GEO-INFER-CLIMATE](../modules/geo-infer-climate.md)** | Climate Analysis | 🔄 In Development | SPACE, TIME, BAYES |
| **[GEO-INFER-ENERGY](../modules/geo-infer-energy.md)** | Energy Systems | 🔄 In Development | SPACE, TIME, ECON |
| **[GEO-INFER-WATER](../modules/geo-infer-water.md)** | Water Resources | 🔄 In Development | SPACE, TIME, RISK |
| **[GEO-INFER-TRANSPORT](../modules/geo-infer-transport.md)** | Transportation | ✅ | SPACE, TIME, LOG |
| **[GEO-INFER-FOREST](../modules/geo-infer-forest.md)** | Forest Management | 🔄 In Development | SPACE, BIO, CLIMATE |
| **[GEO-INFER-MARINE](../modules/geo-infer-marine.md)** | Marine & Coastal | 🔄 In Development | SPACE, BIO, CLIMATE |
| **[GEO-INFER-EMERGENCY](../modules/geo-infer-emergency.md)** | Emergency Management | 🔄 In Development | SPACE, RISK, TRANSPORT |
| **[GEO-INFER-EDU](../modules/geo-infer-edu.md)** | Educational Technology | 🔄 In Development | SPACE, APP |
...
| **[GEO-INFER-EXAMPLES](../modules/geo-infer-examples.md)** | Cross-Module Integration Demos | ✅ Beta | All modules |
...
*Example*: city sensors → real-time inference → automated responses
...
- **Purpose**: Provides spatial analysis capabilities
- **Key Features**:
...
- **Use Cases**: cities, environmental monitoring, industrial IoT
...
#### 🏙️ Urban Planning & Cities

```
GEO-INFER-IOT → GEO-INFER-SPACE → GEO-INFER-ACT → GEO-INFER-AGENT → GEO-INFER-APP
```

*Focus*: Urban analytics, city management, infrastructure optimization
...
|--------|---------------|----------------|-------|----------|
| GEO-INFER-MATH | ✅ | ✅ | 🔄 In Progress | ✅ |
| GEO-INFER-SPACE | ✅ | ✅ | ✅ | ✅ |
| GEO-INFER-TIME | ✅ | ✅ | 🔄 In Progress | 🔄 In Progress |
| GEO-INFER-ACT | ✅ | ✅ | 🔄 In Progress | 🔄 In Progress |
| GEO-INFER-BAYES | ✅ | ✅ | 📝 Planning | 🔄 In Progress |
| GEO-INFER-AI | ✅ | 🔄 Alpha | 🔄 In Progress | 🔄 In Progress |
| GEO-INFER-AGENT | ✅ | 🔄 Alpha | 📝 Planning | 🔄 In Progress |
| GEO-INFER-API | ✅ | 🔄 In Progress | 📝 Planning | 🔄 In Progress |
| GEO-INFER-ANT | ✅ | 🔄 In Progress | 📝 Planning | 📝 Planning |
| GEO-INFER-NORMS | 🔄 In Progress | 📝 Planning | 📝 Planning | 📝 Planning |
| GEO-INFER-METAGOV | 📝 Planning | 📝 Planning | 📝 Planning | 📝 Planning |
| GEO-INFER-IOT | ✅ Beta | 🔄 In Progress | 📝 Planning | 📝 Planning |
| GEO-INFER-HEALTH | ✅ Beta | 🔄 In Progress | 📝 Planning | 📝 Planning |
| GEO-INFER-BIO | ✅ Beta | 🔄 In Progress | 📝 Planning | 📝 Planning |
| GEO-INFER-CLIMATE | ✅ Beta | 🔄 In Progress | 📝 Planning | 📝 Planning |
| GEO-INFER-FOREST | ✅ Beta | 🔄 In Progress | 📝 Planning | 📝 Planning |
| GEO-INFER-COMMS | ✅ Beta | 🔄 In Progress | 📝 Planning | 📝 Planning |
| GEO-INFER-APP | ✅ Beta | 🔄 In Progress | 📝 Planning | 📝 Planning |
| GEO-INFER-ART | ✅ Beta | 🔄 In Progress | 📝 Planning | 📝 Planning |
| GEO-INFER-PLACE | ✅ Beta (H3 v4) | 🔄 In Progress | 📝 Planning | 📝 Planning |
| GEO-INFER-GIT | ✅ Beta | 🔄 In Progress | 📝 Planning | 📝 Planning |
| GEO-INFER-TEST | ✅ Stable | ✅ | ✅ | ✅ |
| GEO-INFER-LOG | ✅ Beta | 🔄 In Progress | 📝 Planning | 📝 Planning |
| GEO-INFER-MARINE | 🔄 Alpha | 🔄 In Progress | 📝 Planning | 📝 Planning |
| GEO-INFER-SPM | 🔄 Alpha (GLM incomplete) | 🔄 In Progress | 📝 Planning | 📝 Planning |
| GEO-INFER-EXAMPLES | ✅ Beta | ✅ | 🔄 In Progress | ✅ |
...
| **Cities** | [City](../examples/smart_city_implementation.md) | IOT, AGENT, APP |

### 🔧 Technical Documentation

| Category | Key Resources | Purpose |
|----------|---------------|---------|
| **API Reference** | [Module APIs](../api/module_reference.md) | API documentation |
...
| **Design** | [Module Design](../architecture/module_design.md) | |
| **Integration** | [Integration Theory](../architecture/integration_theory.md) | |
