...
---
**Ready to get started?** Check out the **[Emergency Coordination Tutorial](../getting_started/index.md)** or explore **[Evacuation Planning Examples](../examples_gallery.md)**!

## 🗺️ Interactive Spatial Preview

Pre-rendered spatial snapshot for **GEO-INFER-EMERGENCY** (*Emergency Management Module*). Reproducible preview cards are generated by `geo_infer_intra.core.documentation.visual_preview`.
