# Agent Instructions: GEO-INFER-INTRA/docs/materiality

## Scope

- Owning module: `GEO-INFER-INTRA`
- Python package: `geo_infer_intra`
- Directory role: Materiality workspace within `GEO-INFER-INTRA`.
...
- `geo-infer-materiality.md`
- `materiality_assessment.md`
