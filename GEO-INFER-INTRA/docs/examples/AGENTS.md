# Agent Instructions: GEO-INFER-INTRA/docs/examples

## Scope

- Owning module: `GEO-INFER-INTRA`
- Python package: `geo_infer_intra`
- Directory role: Examples workspace within `GEO-INFER-INTRA`.
...
- `agricultural_applications.md`
- `agricultural_intelligence.md`
- `climate_modeling.md`
