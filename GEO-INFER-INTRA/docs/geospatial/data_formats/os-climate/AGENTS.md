# Agent Instructions: GEO-INFER-INTRA/docs/geospatial/data_formats/os-climate

## Scope

- Owning module: `GEO-INFER-INTRA`
- Python package: `geo_infer_intra`
- Directory role: Os Climate workspace within `GEO-INFER-INTRA`.
...
- `os-climate_summary.md`
- `os_climate_integration.md`
