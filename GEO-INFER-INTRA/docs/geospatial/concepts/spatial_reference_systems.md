...
```
A Spatial Reference System consists of:
...
### EPSG Registry
The EPSG Registry (European Petroleum Survey Group, now maintained by the International Association of Oil & Gas Producers) provides a database of coordinate reference systems, datums, and transformations.
```mermaid
graph TD
...
- Example: NAD83 + NAVD88 for 3D positioning in North America
...
```
### Best Practices
1. **Always Document the SRS**: Include metadata with all spatial datasets
