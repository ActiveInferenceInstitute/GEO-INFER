# Agent Instructions: GEO-INFER-INTRA/docs/alphaearth

## Scope

- Owning module: `GEO-INFER-INTRA`
- Python package: `geo_infer_intra`
- Directory role: Alphaearth workspace within `GEO-INFER-INTRA`.
...
- `alphaearth-geo-infer.md`
- `alphaearth_summary.md`
