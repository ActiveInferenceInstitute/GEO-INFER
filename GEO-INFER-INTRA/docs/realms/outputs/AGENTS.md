# Agent Instructions: GEO-INFER-INTRA/docs/realms/outputs

## Scope

- Owning module: `GEO-INFER-INTRA`
- Python package: `geo_infer_intra`
- Directory role: Outputs workspace within `GEO-INFER-INTRA`.
...
- `test_run_20250707_155136/`
- `test_run_20250707_155158/`
