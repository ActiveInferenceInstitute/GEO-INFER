...
**Schema Reference:** See `realm_schema.json` for the property list.
-- -
...
```mermaid
graph
TD REALM["Realm"] -- "geometry, attributes"
--> GEO_DATASET["GeospatialDataset"]
```
...
```mermaid
graph TD
"Realms_API_DataSource" -->|"JSON/GeoJSON"| "GEOINFER_API" "GEOINFER_API" --> "GEOINFER_DATA" "GEOINFER_DATA"
--> "GEOINFER_SPACE" "GEOINFER_SPACE"
--> "GEOINFER_INTRA_KB" "GEOINFER_SPACE"
--> "GEOINFER_APP_Visualization" "GEOINFER_SPACE" --> "GEOINFER_AGENT_Modeling"
...
```mermaid
graph TD
Realm_JSON -->|"Schema Mapping"| GEOINFER_Ontology GEOINFER_Ontology -->
Knowledge_Base Knowledge_Base --> Workflow_Engine
```
---
