# Agent Instructions: GEO-INFER-AGENT/src/geo_infer_agent/models/schemas

## Scope

- Owning module: `GEO-INFER-AGENT`
- Python package: `geo_infer_agent`
- Directory role: Schemas workspace within `GEO-INFER-AGENT`.
