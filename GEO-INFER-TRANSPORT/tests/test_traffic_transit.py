...
from geo_infer_transport.core.transit import TransitOptimizer, TransitMode
...
class TestTrafficAnalyzer:
    ...
    def analyzer(self):
        ...
        return TrafficAnalyzer(
            data_sources=["sensor"], model_type="bpr", time_resolution="15min"
        )
    ...
    def test_forecast_traffic(self, analyzer):
        ...
        historical = [{"volume": 1000}, {"volume": 1100}, {"volume": 950}]
    ...
    def test_forecast_horizon_parsing(self, analyzer):
        ...
        assert (
            len(analyzer.forecast_traffic([], forecast_horizon="30m")["forecasts"]) == 2
        )
        assert (
            len(analyzer.forecast_traffic([], forecast_horizon="90m")["forecasts"]) == 6
        )
        assert (
            len(analyzer.forecast_traffic([], forecast_horizon="1d")["forecasts"]) == 96
        )
    ...
    def test_simulate_traffic(self, analyzer):
        ...
        result = analyzer.simulate_traffic(
            network=None, demand_matrix=demand, simulation_hours=1
        )
...
class TestAccessibilityAnalyzer:
    ...
    def analyzer(self):
        ...
        return AccessibilityAnalyzer(
            default_mode="car", population_data={"average_density": 2000}
        )
    ...
    def test_calculate_isochrone(self, analyzer):
        ...
        assert (
            isochrones[0].area_sq_km
            < isochrones[1].area_sq_km
            < isochrones[2].area_sq_km
        )
    ...
    def test_generate_service_area(self, analyzer):
        ...
        areas = analyzer.generate_service_area(
            facilities=facilities, breaks=[1, 2, 5], mode="car"
        )
    ...
    def test_calculate_accessibility_index(self, analyzer):
        ...
        result = analyzer.calculate_accessibility_index(
            origin=origin, destinations=destinations, decay_function="exponential"
        )
...
class TestTransitOptimizer:
    ...
    def optimizer(self):
        ...
        return TransitOptimizer(optimization_objectives=["coverage", "ridership"])
    ...
    def test_optimize_frequencies(self, optimizer):
        ...
        demand = {"r1": {"peak_hourly": 300}, "r2": {"peak_hourly": 500}}
        fleet = {"bus": 20}
    ...
    def test_analyze_coverage(self, optimizer):
        ...
        result = optimizer.analyze_coverage(
            stops=stops, population_zones=zones, walk_radius_m=400
        )
    ...
    def test_design_network(self, optimizer):
        ...
        result = optimizer.design_network(
            demand_zones=demand_zones, constraints={"max_routes": 3}, mode="bus"
        )
    ...
    def test_evaluate_scenario(self, optimizer):
        ...
        changes = [{"type": "add_route", "expected_ridership": 2000}]

        result = optimizer.evaluate_scenario(base_network={}, proposed_changes=changes)
