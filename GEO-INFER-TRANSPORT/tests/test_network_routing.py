...
from geo_infer_transport.core.routing import RoutingEngine, Route, RoutingAlgorithm
...
class TestTransportNetwork:
    ...
    def network(self):
        ...
        return TransportNetwork(
            network_type="road", modes=["car", "bicycle"], crs="EPSG:4326"
        )
    ...
    def test_analyze_connectivity_reachability(self, network, sample_edges):
        ...
        result = network.analyze_connectivity(
            method="reachability", origin="n1", destinations=["n3", "n4"]
        )
    ...
    def test_calculate_centrality(self, network, sample_edges):
        ...
        result = network.calculate_centrality(centrality_type="betweenness", top_n=5)
...
class TestRoutingEngine:
    ...
    def engine(self):
        ...
        return RoutingEngine(
            algorithm="dijkstra", modes=["car"], real_time_traffic=False
        )
    ...
    def test_route_with_network(self, network_with_engine):
        ...
        route = network_with_engine.route(
            origin={"node_id": "n1"}, destination={"node_id": "n3"}
        )
    ...
    def test_optimize_route(self, engine):
        ...
        result = engine.optimize_route(
            waypoints=waypoints, constraints={}, objective="minimize_time"
        )
    ...
    def test_find_alternatives(self, network_with_engine):
        ...
        alternatives = network_with_engine.find_alternatives(
            origin={"node_id": "n1"}, destination={"node_id": "n3"}, count=2
        )
...
class TestNetworkNode:
    ...
    def test_create_node(self):
        ...
        node = NetworkNode(node_id="node_1", location={"lat": 34.0, "lon": -118.0})
