...
| 🏛️ Governance, Risk & Domain | `GEO-INFER-INSURANCE`, `GEO-INFER-RISK`, `GEO-INFER-METAGOV`, `GEO-INFER-NORMS`, `GEO-INFER-ECON`, `GEO-INFER-PEP`, `GEO-INFER-REQ`, `GEO-INFER-SEC`, `GEO-INFER-CIV`, `GEO-INFER-HEALTH`, `GEO-INFER-ORG` |
...
| `GEO-INFER-PLACE` | `geo_infer_place` | 39 | 22 |
