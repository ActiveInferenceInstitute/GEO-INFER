...
| --- | ---: |
| Modules | 44 |
| Python source files | 930 |
| Python test files | 576 |
...
| --- | --- | ---: | ---: |
| `GEO-INFER-ACT` | `geo_infer_act` | 47 | 44 |
...
| `GEO-INFER-PLACE` | `geo_infer_place` | 38 | 21 |
...
| `GEO-INFER-SPACE` | `geo_infer_space` | 83 | 37 |
