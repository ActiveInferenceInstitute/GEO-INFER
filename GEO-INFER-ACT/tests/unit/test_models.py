...
class TestUrbanModel(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures."""
        self.model = UrbanModel(
            n_agents=2, n_resources=2, n_locations=3, planning_horizon=2
        )
...
class TestClimateModel(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        from geo_infer_act.core.active_inference import (
            ActiveInferenceModel as CoreActiveInferenceModel,
        )
