...
class TestSpatialPerception:
    ...
    def test_basic_perception(self):
        ...
        updated = agent.spatial_perception(observations, propagate_beliefs=False)
    ...
    def test_observation_history_recorded(self):
        ...
        agent = SpatialActiveInferenceAgent(initial_cells=["c1", "c2"])
        
        obs = {"c1": np.array([0.5, 0.5, 0.0, 0.0])}
...
class TestSpatialAction:
    ...
    def test_action_selection(self):
        ...
        # First do perception
        agent.spatial_perception({"c1": np.array([1.0, 0.0, 0.0, 0.0])})
    ...
    def test_action_history_recorded(self):
        ...
        agent = SpatialActiveInferenceAgent(initial_cells=["c1"])
    ...
    def test_policy_distribution_sums_to_one(self):
        ...
        agent.spatial_perception({"c1": np.array([0.5, 0.5, 0.0, 0.0])})
        result = agent.spatial_action()
...
class TestStepFunction:
    ...
    def test_step_returns_all_components(self):
        ...
        result = agent.step({"c1": np.array([1.0, 0.0, 0.0, 0.0])})
...
class TestDiagnostics:
    ...
    def test_get_diagnostics(self):
        ...
        agent = SpatialActiveInferenceAgent(initial_cells=["c1", "c2", "c3"])
        
        # Run a few steps
        for _ in range(3):
            agent.step({"c1": np.random.rand(4)})
    ...
    def test_export_results_json(self):
        ...
        agent.step({"c1": np.array([1.0, 0.0, 0.0, 0.0])})
        agent.step({"c1": np.array([0.0, 1.0, 0.0, 0.0])})
...
class TestPreferencesAndModels:
    ...
    def test_set_preferences(self):
        ...
        preferences = {"c1": np.array([0.8, 0.1, 0.1])}
...
class TestFreeEnergyComputation:
    ...
    def test_free_energy_decreases_with_learning(self):
        ...
        consistent_obs = {"c1": np.array([1.0, 0.0, 0.0, 0.0])}
