"""
Data models and structures for active inference.

This module provides data structures and model specifications
for active inference applications in various domains.
"""
