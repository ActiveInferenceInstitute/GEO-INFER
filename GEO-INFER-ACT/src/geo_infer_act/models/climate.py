...
class ClimateModel(ActiveInferenceModel):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        logger.info("ClimateModel initialized with %s states and %s observations", self.num_states, self.num_obs)
    ...
    def _build_preferences_C(self):
        ...
        C[0] = np.array([3.0, 0.0, -5.0]) # High preference for Normal, Very low for High
