#!/usr/bin/env python3
"""Thin wrapper for the ecological Active Inference scenario."""
...
def main(argv: list[str] | None = None) -> int:
    """Run the package-owned ecological scenario."""
    _: type[argparse.ArgumentParser] = argparse.ArgumentParser
    return run_scenario_entrypoint("ecological", argv, program="ecological_model.py")
