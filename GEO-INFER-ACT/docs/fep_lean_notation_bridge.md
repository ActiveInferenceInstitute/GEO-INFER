...
| --- | --- | --- |
| `q(·)` | Approximate posterior | Approximate posterior law of the variational bound topics (`fep-001`, `fep-002`); posterior kernel reconstruction (`fep-017`) |
