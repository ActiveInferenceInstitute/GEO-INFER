# GEO-INFER-TEST/examples

Examples workspace within `GEO-INFER-TEST`.
...
- `basic_testing_example.py:main` (function)
- `basic_testing_example.py:demo_cross_module_testing` (function)
- `basic_testing_example.py:demo_health_monitoring` (function)
