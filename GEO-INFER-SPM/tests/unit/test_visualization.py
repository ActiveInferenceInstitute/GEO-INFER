    ...
    def test_statistical_map_with_contrast(self):
        ...
        try:
            ...
            viz_data = create_statistical_map(
                self.spm_result, contrast_idx=0, threshold=0.05, colormap="viridis"
            )
    ...
    def test_diagnostic_helper_functions(self):
        ...
        try:
            from geo_infer_spm.visualization.diagnostics import (
                ...
                _plot_qq_residuals,  # noqa: F401
                _plot_residuals_vs_fitted,  # noqa: F401
            )
...
class TestInteractiveVisualization:
    ...
    def test_create_time_series_explorer(self):
        ...
        try:
            from geo_infer_spm.visualization.interactive import (
...
class TestVisualizationDataStructures:
    ...
    def test_statistical_map_data_format(self):
        ...
        try:
            ...
            spm_data = SPMData(
                data=np.random.randn(10), coordinates=coordinates, crs="EPSG:4326"
            )
    ...
    def test_visualization_error_handling(self):
        ...
        try:
            ...
            coordinates = np.column_stack(
                [np.random.uniform(-179, 179, 5), np.random.uniform(-89, 89, 5)]
            )
            spm_data = SPMData(
                data=np.random.randn(5), coordinates=coordinates, crs="EPSG:4326"
            )
