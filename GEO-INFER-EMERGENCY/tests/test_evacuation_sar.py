...
class TestEvacuationPlanner:
    ...
    def road_network(self):
        ...
        graph = nx.DiGraph()
        graph.add_edge(
            "zone_1", "shelter_1", distance=12.0, travel_time=18.0, capacity=1200
        )
        return graph
            ...
            sources=[
                {
                    "id": "src_1",
                    "confidence": 0.9,
                    "data": {"temperature": 80, "wind_speed": 15},
                },
                {
                    "id": "src_2",
                    "confidence": 0.7,
                    "data": {"temperature": 85, "humidity": 30},
                },
            ],
...
class TestSearchAndRescue:
    ...
    def sar(self):
        ...
        return SearchAndRescue(team_capabilities=["ground", "k9", "aerial"])
    ...
    def test_update_probability(self, sar):
        ...
        result = sar.update_probability(
            area_id="area_1", search_result="negative", new_information=None
        )
