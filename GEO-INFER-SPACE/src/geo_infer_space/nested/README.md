# GEO-INFER-SPACE/src/geo_infer_space/nested

Nested workspace within `GEO-INFER-SPACE`.
...
- `__init__.py:get_component_status` (function)
- `__init__.py:create_nested_system` (function)
