...
class GISManager:
    ...
    def aggregate_to_region(
        ...
        """
        return self.methods.aggregate_to_region(cells, values, target_resolution, aggregation)
    ...
    def disaggregate_to_cells(
        ...
        """
        return self.methods.disaggregate_to_cells(parent_cells, values, target_resolution, method)
    ...
    def spatial_filter(
        ...
        """
        return self.methods.spatial_filter(cells, values, filter_type, threshold, percentile, top_n)
    ...
    def compute_accessibility(
        ...
        """
        return self.methods.compute_accessibility(origin_cells, destination_cells, max_distance)
