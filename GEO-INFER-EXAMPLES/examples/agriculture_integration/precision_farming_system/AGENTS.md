# Agent Instructions: GEO-INFER-EXAMPLES/examples/agriculture_integration/precision_farming_system

## Scope

- Owning module: `GEO-INFER-EXAMPLES`
- Python package: `geo_infer_examples`
- Directory role: Precision Farming System workspace within `GEO-INFER-EXAMPLES`.
