...
: scripts ## Scope
 ...
 and Functions ### IOTOrchestrato
r
 Thin orchestrator for GEO-INFER-IOT module demonstrations. **Methods**: - `run_orchestrator()`: Run the IOT module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/IOT/scripts` - **Type**: Directory Node 