...
: scripts ## Scope
 ...
 and Functions ### ACTOrchestrato
r
 Thin orchestrator for GEO-INFER-ACT module demonstrations. **Methods**: - `run_orchestrator()`: Run the ACT module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/ACT/scripts` - **Type**: Directory Node 