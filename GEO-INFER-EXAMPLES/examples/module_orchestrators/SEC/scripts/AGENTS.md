...
: scripts ## Scope
 ...
 and Functions ### SECOrchestrato
r
 Thin orchestrator for GEO-INFER-SEC module demonstrations. **Methods**: - `run_orchestrator()`: Run the SEC module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/SEC/scripts` - **Type**: Directory Node 