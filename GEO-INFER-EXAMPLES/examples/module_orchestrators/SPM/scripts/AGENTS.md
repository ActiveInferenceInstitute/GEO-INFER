...
: scripts ## Scope
 ...
 and Functions ### SPMOrchestrato
r
 Thin orchestrator for GEO-INFER-SPM module demonstrations. **Methods**: - `run_orchestrator()`: Run the SPM module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/SPM/scripts` - **Type**: Directory Node 