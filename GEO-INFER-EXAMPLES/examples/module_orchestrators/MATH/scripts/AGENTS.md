...
: scripts ## Scope
 ...
 and Functions ### MATHOrchestrato
r
 Thin orchestrator for GEO-INFER-MATH module demonstrations. **Methods**: - `run_orchestrator()`: Run the MATH module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/MATH/scripts` - **Type**: Directory Node 