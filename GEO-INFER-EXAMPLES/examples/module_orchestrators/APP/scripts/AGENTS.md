...
: scripts ## Scope
 ...
 and Functions ### APPOrchestrato
r
 Thin orchestrator for GEO-INFER-APP module demonstrations. **Methods**: - `run_orchestrator()`: Run the APP module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/APP/scripts` - **Type**: Directory Node 