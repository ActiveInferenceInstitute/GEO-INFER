...
**GEO-INFER-APP: Applications Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-APP, showcasing applications for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the APP module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/APP
