...
: scripts ## Scope
 ...
 and Functions ### AGENTOrchestrato
r
 Thin orchestrator for GEO-INFER-AGENT module demonstrations. **Methods**: - `run_orchestrator()`: Run the AGENT module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/AGENT/scripts` - **Type**: Directory Node 