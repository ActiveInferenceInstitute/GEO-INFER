...
**GEO-INFER-AGENT: Intelligent agents Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-AGENT, showcasing intelligent agents for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the AGENT module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/AGENT
