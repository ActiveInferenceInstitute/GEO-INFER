# AG Module Orchestrator

**GEO-INFER-AG: Agriculture Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-AG, showcasing agriculture for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the AG module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/AG
