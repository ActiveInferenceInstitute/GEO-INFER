...
: scripts ## Scope
 ...
 and Functions ### SIMOrchestrato
r
 Thin orchestrator for GEO-INFER-SIM module demonstrations. **Methods**: - `run_orchestrator()`: Run the SIM module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/SIM/scripts` - **Type**: Directory Node 