# SIM Module Orchestrator

**GEO-INFER-SIM: Simulation Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-SIM, showcasing simulation for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the SIM module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/SIM
