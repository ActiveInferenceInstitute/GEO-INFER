# OPS Module Orchestrator

**GEO-INFER-OPS: Operations Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-OPS, showcasing operations for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the OPS module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/OPS
