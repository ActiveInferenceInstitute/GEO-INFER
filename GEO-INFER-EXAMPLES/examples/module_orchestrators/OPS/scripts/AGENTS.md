...
: scripts ## Scope
 ...
 and Functions ### OPSOrchestrato
r
 Thin orchestrator for GEO-INFER-OPS module demonstrations. **Methods**: - `run_orchestrator()`: Run the OPS module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/OPS/scripts` - **Type**: Directory Node 