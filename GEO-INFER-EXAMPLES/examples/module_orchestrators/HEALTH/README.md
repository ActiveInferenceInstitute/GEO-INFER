...
**GEO-INFER-HEALTH: Health applications Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-HEALTH, showcasing health applications for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the HEALTH module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/HEALTH
