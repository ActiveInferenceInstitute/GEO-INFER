...
: scripts ## Scope
 ...
 and Functions ### BIOOrchestrato
r
 Thin orchestrator for GEO-INFER-BIO module demonstrations. **Methods**: - `run_orchestrator()`: Run the BIO module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/BIO/scripts` - **Type**: Directory Node 