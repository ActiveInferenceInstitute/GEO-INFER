# BIO Module Orchestrator

**GEO-INFER-BIO: Bioinformatics Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-BIO, showcasing bioinformatics for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the BIO module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/BIO
