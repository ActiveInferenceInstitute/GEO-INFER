# REQ Module Orchestrator

**GEO-INFER-REQ: Requirements Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-REQ, showcasing requirements for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the REQ module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/REQ
