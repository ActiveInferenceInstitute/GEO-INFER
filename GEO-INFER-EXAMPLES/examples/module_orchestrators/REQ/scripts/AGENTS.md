...
: scripts ## Scope
 ...
 and Functions ### REQOrchestrato
r
 Thin orchestrator for GEO-INFER-REQ module demonstrations. **Methods**: - `run_orchestrator()`: Run the REQ module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/REQ/scripts` - **Type**: Directory Node 