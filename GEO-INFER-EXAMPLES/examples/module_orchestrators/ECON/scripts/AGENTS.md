...
: scripts ## Scope
 ...
 and Functions ### ECONOrchestrato
r
 Thin orchestrator for GEO-INFER-ECON module demonstrations. **Methods**: - `run_orchestrator()`: Run the ECON module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/ECON/scripts` - **Type**: Directory Node 