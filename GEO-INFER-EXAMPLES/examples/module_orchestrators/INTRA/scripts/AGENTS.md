...
: scripts ## Scope
 ...
 and Functions ### INTRAOrchestrato
r
 Thin orchestrator for GEO-INFER-INTRA module demonstrations. **Methods**: - `run_orchestrator()`: Run the INTRA module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/INTRA/scripts` - **Type**: Directory Node 