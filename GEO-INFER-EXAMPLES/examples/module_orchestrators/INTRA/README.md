# INTRA Module Orchestrator

**GEO-INFER-INTRA: Documentation Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-INTRA, showcasing documentation for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the INTRA module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/INTRA
