...
: scripts ## Scope
 ...
 and Functions ### TIMEOrchestrato
r
 Thin orchestrator for GEO-INFER-TIME module demonstrations. **Methods**: - `run_orchestrator()`: Run the TIME module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/TIME/scripts` - **Type**: Directory Node 