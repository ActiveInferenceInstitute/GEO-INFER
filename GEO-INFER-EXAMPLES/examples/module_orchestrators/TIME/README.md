# TIME Module Orchestrator

**GEO-INFER-TIME: Temporal methods Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-TIME, showcasing temporal methods for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the TIME module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/TIME
