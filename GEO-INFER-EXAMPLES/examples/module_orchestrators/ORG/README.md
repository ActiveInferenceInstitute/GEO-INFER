# ORG Module Orchestrator

**GEO-INFER-ORG: Organizations Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-ORG, showcasing organizations for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the ORG module
...
### Required Modules
```bash
# Install the ORG module
pip install -e ../../../../GEO-INFER-ORG
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/ORG
