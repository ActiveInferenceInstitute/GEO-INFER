...
: scripts ## Scope
 ...
 and Functions ### ORGOrchestrato
r
 Thin orchestrator for GEO-INFER-ORG module demonstrations. **Methods**: - `run_orchestrator()`: Run the ORG module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/ORG/scripts` - **Type**: Directory Node 