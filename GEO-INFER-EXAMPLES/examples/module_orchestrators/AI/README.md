...
**GEO-INFER-AI: Artificial Intelligence Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-AI, showcasing artificial intelligence for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the AI module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/AI
