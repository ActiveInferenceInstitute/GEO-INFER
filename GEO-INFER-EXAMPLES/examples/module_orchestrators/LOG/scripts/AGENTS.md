...
: scripts ## Scope
 ...
 and Functions ### LOGOrchestrato
r
 Thin orchestrator for GEO-INFER-LOG module demonstrations. **Methods**: - `run_orchestrator()`: Run the LOG module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/LOG/scripts` - **Type**: Directory Node 