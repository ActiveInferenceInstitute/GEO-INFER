# COMMS Module Orchestrator

**GEO-INFER-COMMS: Communications Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-COMMS, showcasing communications for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the COMMS module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/COMMS
