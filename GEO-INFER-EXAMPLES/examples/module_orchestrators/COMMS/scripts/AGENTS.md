...
: scripts ## Scope
 ...
 and Functions ### COMMSOrchestrato
r
 Thin orchestrator for GEO-INFER-COMMS module demonstrations. **Methods**: - `run_orchestrator()`: Run the COMMS module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/COMMS/scripts` - **Type**: Directory Node 