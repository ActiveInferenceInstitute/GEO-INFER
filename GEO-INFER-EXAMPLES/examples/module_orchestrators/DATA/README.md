...
**GEO-INFER-DATA: Data management and ETL Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-DATA, showcasing data management and etl for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the DATA module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/DATA
