...
: scripts ## Scope
 ...
 and Functions ### DATAOrchestrato
r
 Thin orchestrator for GEO-INFER-DATA module demonstrations. **Methods**: - `run_orchestrator()`: Run the DATA module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/DATA/scripts` - **Type**: Directory Node 