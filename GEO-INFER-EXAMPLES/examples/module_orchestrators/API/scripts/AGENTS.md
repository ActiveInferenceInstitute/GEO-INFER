...
: scripts ## Scope
 ...
 and Functions ### APIOrchestrato
r
 Thin orchestrator for GEO-INFER-API module demonstrations. **Methods**: - `run_orchestrator()`: Run the API module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/API/scripts` - **Type**: Directory Node 