# ART Module Orchestrator

**GEO-INFER-ART: Artistic expression Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-ART, showcasing artistic expression for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the ART module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/ART
