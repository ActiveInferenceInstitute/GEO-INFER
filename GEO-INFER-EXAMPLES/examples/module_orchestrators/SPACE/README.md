# SPACE Module Orchestrator

**GEO-INFER-SPACE: Spatial methods with H3 v4 Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-SPACE, showcasing spatial methods with h3 v4 for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the SPACE module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/SPACE
