...
: scripts ## Scope
 ...
 and Functions ### SPACEOrchestrato
r
 Thin orchestrator for GEO-INFER-SPACE module demonstrations. **Methods**: - `run_orchestrator()`: Run the SPACE module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/SPACE/scripts` - **Type**: Directory Node 