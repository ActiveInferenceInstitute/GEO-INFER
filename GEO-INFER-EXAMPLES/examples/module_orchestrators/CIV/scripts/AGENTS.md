...
: scripts ## Scope
 ...
 and Functions ### CIVOrchestrato
r
 Thin orchestrator for GEO-INFER-CIV module demonstrations. **Methods**: - `run_orchestrator()`: Run the CIV module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/CIV/scripts` - **Type**: Directory Node 