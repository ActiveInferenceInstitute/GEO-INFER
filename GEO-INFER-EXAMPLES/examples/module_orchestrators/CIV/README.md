# CIV Module Orchestrator

**GEO-INFER-CIV: Civic engagement Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-CIV, showcasing civic engagement for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the CIV module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/CIV
