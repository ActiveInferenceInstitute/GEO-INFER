# PEP Module Orchestrator

**GEO-INFER-PEP: People management Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-PEP, showcasing people management for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the PEP module
...
### Required Modules
```bash
# Install the PEP module
pip install -e ../../../../GEO-INFER-PEP
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/PEP
