...
: scripts ## Scope
 ...
 and Functions ### PEPOrchestrato
r
 Thin orchestrator for GEO-INFER-PEP module demonstrations. **Methods**: - `run_orchestrator()`: Run the PEP module demonstration. ### setup_loggin
g
...
n
 ...
 - **Location**: `examples/module_orchestrators/PEP/scripts` - **Type**: Directory Node 