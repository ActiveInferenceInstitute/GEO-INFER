...
**GEO-INFER-TEST: Testing framework Orchestrator**

## Overview

This orchestrator demonstrates the core capabilities of GEO-INFER-TEST, showcasing testing framework for geospatial analysis.

## Learning Objectives

After running this orchestrator, you will:
- Understand how to initialize and configure the TEST module
...
cd GEO-INFER-EXAMPLES/examples/module_orchestrators/TEST
