# Agent Instructions: GEO-INFER-EXAMPLES/examples/getting_started/basic_integration_demo

## Scope

- Owning module: `GEO-INFER-EXAMPLES`
- Python package: `geo_infer_examples`
- Directory role: Basic Integration Demo workspace within `GEO-INFER-EXAMPLES`.
