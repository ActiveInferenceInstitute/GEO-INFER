# Agent Instructions: GEO-INFER-EXAMPLES/examples/health_integration/disease_surveillance_pipeline

## Scope

- Owning module: `GEO-INFER-EXAMPLES`
- Python package: `geo_infer_examples`
- Directory role: Disease Surveillance Pipeline workspace within `GEO-INFER-EXAMPLES`.
