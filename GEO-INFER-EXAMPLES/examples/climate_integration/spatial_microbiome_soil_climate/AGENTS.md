# Agent Instructions: GEO-INFER-EXAMPLES/examples/climate_integration/spatial_microbiome_soil_climate

## Scope

- Owning module: `GEO-INFER-EXAMPLES`
- Python package: `geo_infer_examples`
- Directory role: Spatial Microbiome Soil Climate workspace within `GEO-INFER-EXAMPLES`.
