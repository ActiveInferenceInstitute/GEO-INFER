# Agent Instructions: GEO-INFER-PEP

## Scope

- Owning module: `GEO-INFER-PEP`
- Python package: `geo_infer_pep`
- Directory role: Comprehensive people operations management including HR, CRM, talent acquisition, performance tracking, and community engagement.
