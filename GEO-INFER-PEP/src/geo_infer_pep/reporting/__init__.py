...
from .crm_reports import (
    generate_customer_segmentation_report,
    generate_lead_conversion_report,
    get_quarterly_metrics as get_crm_quarterly_metrics,
)
from .hr_reports import (
    generate_headcount_report,
    generate_diversity_report,
    get_quarterly_metrics as get_hr_quarterly_metrics,
)
from .talent_reports import (
    generate_candidate_pipeline_report,
    calculate_time_to_hire,
    get_quarterly_metrics as get_talent_quarterly_metrics,
)
