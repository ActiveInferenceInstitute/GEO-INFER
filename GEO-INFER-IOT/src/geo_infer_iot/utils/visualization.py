...
class IoTVisualization:
    ...
    def __init__(self, config: Optional[Dict] = None):
        ...
        if not HAS_VISUALIZATION:
            logger.warning("Visualization libraries not available - map generation disabled")

        logger.info("IoTVisualization initialized")

    def create_sensor_map(self, sensors: List[Dict], measurements: Optional[List[Dict]] = None,
                         output_file: str = "sensor_map.html") -> Dict:
        """
        ...
        try:
            ...
            if sensors:
                ...
                longitudes = [s.get('longitude', 0) for s in sensors if 'longitude' in s]
    ...
    def create_spatial_interpolation_map(self, interpolation_data: Dict,
                                      sensors: Optional[List[Dict]] = None,
                                      output_file: str = "interpolation_map.html") -> Dict:
        """
        ...
        try:
            ...
            for i, (lat, lon) in enumerate(target_coordinates):
                ...
                unc = uncertainty[i] if i < len(uncertainty) else 0.5
    ...
    def create_time_series_plot(self, sensor_data: Dict[str, List], output_file: str = "timeseries.png") -> Dict:
        """
        ...
        try:
            ...
            for sensor_id, data_points in sensor_data.items():
                ...
                # Plot time series
                ax.plot(timestamps, values, marker='o', label=f'Sensor {sensor_id}', linewidth=2)
    ...
    def create_network_status_dashboard(self, network_data: Dict, output_file: str = "dashboard.html") -> Dict:
        """
    ...
    def create_heatmap_overlay(self, measurements: List[Dict], bounds: Dict[str, float],
                              output_file: str = "heatmap.png") -> Dict:
        """
        ...
        try:
            ...
            scatter = ax.scatter(longitudes, latitudes, c=values, cmap='viridis',
