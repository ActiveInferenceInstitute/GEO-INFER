# GEO-INFER-SIM/src/geo_infer_sim/scenarios

Scenarios workspace within `GEO-INFER-SIM`.
...
- `scenario_manager.py:Scenario` (class)
- `scenario_manager.py:ScenarioManager` (class)
