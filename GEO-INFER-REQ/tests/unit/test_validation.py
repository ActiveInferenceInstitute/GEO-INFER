    ...
    v.add_specs(
        [
            RequirementSpec(
                "R1",
                "Authentication",
                "Implement OAuth2 authentication with multi-factor",
                priority=4,
            ...
            RequirementSpec(
                "R2",
                "Data API",
                "Build REST API for geospatial data management",
                priority=3,
            ...
            RequirementSpec(
                "R3",
                "Frontend",
                "Build the user interface for the dashboard application",
                priority=2,
...
class TestRequirementValidator:
    ...
    def test_dangling_dependency(self):
        ...
        v.add_spec(
            RequirementSpec(
                "R1",
                "Req",
                "A requirement with a valid long description",
                priority=3,
                effort_estimate=5.0,
        ...
        v.add_specs(
            [
                RequirementSpec(
                    "A",
                    "Req A",
                    "Requirement A has enough description text",
                    priority=3,
                    effort_estimate=5.0,
                    dependencies=["B"],
                ),
                RequirementSpec(
                    "B",
                    "Req B",
                    "Requirement B has enough description text",
                    priority=3,
                    effort_estimate=5.0,
                    dependencies=["A"],
                ),
        ...
        v.add_specs(
            [
                RequirementSpec(
                    "R1",
                    "Same Title",
                    "Description one is long enough for validation",
                    priority=3,
                    effort_estimate=5.0,
                ),
                RequirementSpec(
                    "R2",
                    "Same Title",
                    "Description two is long enough for validation",
                    priority=3,
                    effort_estimate=5.0,
                ),
            ]
    ...
    def test_short_description_warning(self):
        v = RequirementValidator()
        v.add_spec(
            RequirementSpec("R1", "Req", "Short", priority=3, effort_estimate=5.0)
        )
        report = v.check_consistency()
        ...
        v.add_specs(
            [
                RequirementSpec(
                    "R1",
                    "A",
                    "Description A is sufficiently long for tests",
                    priority=3,
                    effort_estimate=5.0,
                ...
                RequirementSpec(
                    "R2",
                    "B",
                    "Description B is sufficiently long for tests",
                    priority=3,
                    effort_estimate=5.0,
    ...
    def test_bottleneck_detection(self):
        ...
        v.add_spec(
            RequirementSpec(
                "R1",
                "Bottleneck",
                "This requirement depends on many others heavily",
                priority=3,
                effort_estimate=5.0,
    ...
    def test_untagged_spec_produces_info_item(self):
        ...
        v.add_spec(
            RequirementSpec(
                "R1",
                "Req",
                "A description long enough for validation checks",
                priority=3,
                effort_estimate=5.0,
            )
        )
