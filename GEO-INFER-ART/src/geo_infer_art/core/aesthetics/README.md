# GEO-INFER-ART/src/geo_infer_art/core/aesthetics

Aesthetics workspace within `GEO-INFER-ART`.
...
- `color_palette.py:ColorPalette` (class)
- `style_transfer.py:StyleTransfer` (class)
