...
class PriorBuilders:
    ...
    def _normal(self, size: int, **kwargs) -> np.ndarray:
    ...
    def _beta(self, size: int, **kwargs) -> np.ndarray:
    ...
    def _gamma(self, size: int, **kwargs) -> np.ndarray:
    ...
    def _dirichlet(self, size: int, **kwargs) -> np.ndarray:
    ...
    def _informative(self, size: int, **kwargs) -> np.ndarray:
