...
from geo_infer_math.core.theorem_proving.prover import TheoremProver, ProofResult, ProofStatus
...
class GeometricProofStrategy(ProofStrategy):
    ...
    def can_apply(self, theorem: str) -> bool:
        ...
        geometric_keywords = [
            "triangle", "distance", "angle", "polygon",
            "circle", "line", "point", "geometric"
        ]
...
class StatisticalProofStrategy(ProofStrategy):
    ...
    def can_apply(self, theorem: str) -> bool:
        ...
        statistical_keywords = [
            ...
            "probability", "statistical", "random"
        ]
