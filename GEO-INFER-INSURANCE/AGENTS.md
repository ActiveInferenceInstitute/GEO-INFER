# Agent Instructions: GEO-INFER-INSURANCE

## Scope

- Owning module: `GEO-INFER-INSURANCE`
- Python package: `geo_infer_insurance`
- Directory role: Underwriting, policy, claims, and pricing operations for geospatial insurance workflows within the GEO-INFER framework.
