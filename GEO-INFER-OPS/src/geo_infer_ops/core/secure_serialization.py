"""
Authenticated serialization envelopes for GEO-INFER-OPS.

This module is the trust boundary for payloads written to and read
from Redis by :class:`geo_infer_ops.core.cache.CacheManager`, in both the
JSON (text) and pickle (binary) serializer modes.
...
CONTEXT_REDIS_CACHE = "ops.cache.redis"
