"""
Authenticated serialization envelopes for GEO-INFER-GIT.

This module is the trust boundary for every persisted payload in
:mod:`geo_infer_git.utils.advanced_cache`: the SQLite-backed disk cache and
the Redis distributed cache.
...
CONTEXT_DISK_CACHE = "git.cache.disk"
CONTEXT_REDIS_CACHE = "git.cache.redis"
